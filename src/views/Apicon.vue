<template>
    <div>
        ...
        <v-row>
            <v-col cole="12" md="4" v-for="(item, index) in apiData" :key="index">
                <v-card width="350">
                    <v-img src="../assets/cat.jpg" />
                    <v-card-title primary-title>
                        <span>แมวหิว: {{ item.product_name }}</span>
                    </v-card-title>
                    <v-card-actions>
                ...
                <v-card-text>
                    <v-row>
                        <v-col cols="12">
                            ...
                            <v-text-field name="price" label="ราคา" id="price"
                                v-model="postdata.price"></v-text-field>
                            <v-text-field name="Type" label="ประเภทสินค้า" id="Type"
                                v-model="postdata.Type"></v-text-field>
                        </v-col>
                    </v-row>
                </v-card-text>
                <v-card-actions>
